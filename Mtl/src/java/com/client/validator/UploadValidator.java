...
public class UploadValidator implements Validator {
    ...
    public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
        ...
        if (!"image/jpeg".equals(valor.getContentType())) {
            throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, "solo imagenes formato .jpeg , ", "dimension 100 x"
