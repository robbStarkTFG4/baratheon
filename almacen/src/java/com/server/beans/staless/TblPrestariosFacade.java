...
public class TblPrestariosFacade extends AbstractFacade<TblPrestarios> {
    ...
    public boolean modificar(int id, String nombre, String apaterno, String amaterno, int tipo, String tel, String email,
            String usuario, String carrera, int estado) {
        ...
        try {
            ...
            if (usuario.equals(bp)) {
                ...
                pres.setEmail(email);
                pres.setUsuario(usuario);
                System.err.println("EL VALOR DE ACTIVO: " + estado);
                pres.setActivo(estado);
                TblTipoprestarios tp = new TblTipoprestarios();
                tp.setIdTipoprestarios(tipo);
                pres.setIdTipoprestarios(tp);
