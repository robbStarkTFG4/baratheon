...
public class TblMaterialFacade extends AbstractFacade<TblMaterial> {
    ...
    public List<TblMaterial> autoQueryName(String patron) {
        ...
        TypedQuery<TblMaterial> query = em.createQuery("SELECT NEW com.server.entity.beans.TblMaterial( c.noParte,c.nombre,c.showInQuery) FROM TblMaterial c WHERE c.nombre LIKE :patron", TblMaterial.class);
        query.setParameter("patron", patron.toLowerCase() + "%");

        List<TblMaterial> res = query.getResultList();
        res.add(new TblMaterial(patron, "Buscar: ", true));
    ...
    public List<TblMaterial> autoQueryPartNumber(String patron) {
        //
        TypedQuery<TblMaterial> query = em.createQuery("SELECT NEW com.server.entity.beans.TblMaterial(c.noParte,c.nombre,c.showInQuery) FROM TblMaterial c WHERE c.noParte LIKE :patron", TblMaterial.class);
        query.setParameter("patron", patron.toLowerCase() + "%");

        List<TblMaterial> res = query.getResultList();
        res.add(new TblMaterial(patron, "noParte", true));
        return res;
    }
    ...
    public List<TblMaterial> find(String search) {// lista normal por numero de parte //ESTOS NO              wwwwwwwwwwwwwwwwwwwwwwwwwww
        ...
        Query res = em.createQuery("SELECT c.idtblMaterial,c.noParte,c.nombre,c.descripcion,c.stock,c.costo,c.imagen, c.idArea.idArea, "
                ...
                + "c.subFamiliasidsubFam.nombre , c.inventariable, c.showInQuery  FROM TblMaterial c WHERE c.noParte = :part");
    ...
    public List<TblMaterial> find(String patronPartNumber, boolean obj, int x) {// llista patron # parte  wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww
        Query res = em.createQuery("SELECT c.idtblMaterial,c.noParte,c.nombre,c.descripcion,c.stock,c.costo,c.imagen, c.idArea.idArea, "
                + "c.idTipomaterial.idTipomaterial,c.subFamiliasidsubFam.idsubFam , c.idArea.descripcion, c.idTipomaterial.descripcion, "
                + "c.subFamiliasidsubFam.nombre, c.inventariable,c.showInQuery   FROM TblMaterial c WHERE c.noParte LIKE  :part");
    ...
    public List<TblMaterial> catalogFindByArea(int id) {                //wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww
        Query query = em.createQuery("SELECT  c.idtblMaterial,c.noParte,c.nombre,c.descripcion,c.stock,c.costo,c.imagen, c.idArea.idArea, "
                + "c.idTipomaterial.idTipomaterial,c.subFamiliasidsubFam.idsubFam, c.idArea.descripcion, c.idTipomaterial.descripcion, "
                + "c.subFamiliasidsubFam.nombre, c.inventariable,c.showInQuery  FROM TblMaterial c WHERE c.idArea.idArea = :id");
    ...
    public List<TblMaterial> catalogFindByArea(Integer id, String patronName) {
        Query res = em.createQuery("SELECT c.idtblMaterial,c.noParte,c.nombre,c.descripcion,c.stock,c.costo,c.imagen, c.idArea.idArea, c.idTipomaterial.idTipomaterial,c.subFamiliasidsubFam.idsubFam , c.idArea.descripcion, c.idTipomaterial.descripcion, c.subFamiliasidsubFam.nombre, c.inventariable , c.showInQuery FROM TblMaterial c WHERE c.nombre LIKE  :part AND c.idTipomaterial.tblAreaIdArea.idArea = :id");
        res.setParameter("part", patronName.toLowerCase() + "%");
    ...
    public List<TblMaterial> catalogFindByArea(Integer id, String patronNoParte, int x) {
        Query res = em.createQuery("SELECT c.idtblMaterial,c.noParte,c.nombre,c.descripcion,c.stock,c.costo,c.imagen, c.idArea.idArea, c.idTipomaterial.idTipomaterial,c.subFamiliasidsubFam.idsubFam , c.idArea.descripcion, c.idTipomaterial.descripcion, c.subFamiliasidsubFam.nombre, c.inventariable, c.showInQuery  FROM TblMaterial c WHERE c.noParte LIKE  :part AND c.idTipomaterial.tblAreaIdArea.idArea = :id");
    ...
    public List<TblMaterial> catalogFindByType(int id) {    //wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww
        Query query = em.createQuery("SELECT  c.idtblMaterial,c.noParte,c.nombre,c.descripcion,c.stock,c.costo,c.imagen, c.idArea.idArea, "
                + "c.idTipomaterial.idTipomaterial,c.subFamiliasidsubFam.idsubFam, c.idArea.descripcion, c.idTipomaterial.descripcion, "
                + "c.subFamiliasidsubFam.nombre, c.inventariable, c.showInQuery  FROM TblMaterial c WHERE c.idTipomaterial.idTipomaterial = :id");
        query.setParameter("id", id);
        List<TblMaterial> data = mtlResults(query);
        return data;
    }
    ...
    public List<TblMaterial> catalogFindBySubFam(int id) {   //wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww
        Query query = em.createQuery("SELECT  c.idtblMaterial,c.noParte,c.nombre,c.descripcion,c.stock,c.costo,c.imagen, c.idArea.idArea,"
                + "c.idTipomaterial.idTipomaterial,c.subFamiliasidsubFam.idsubFam, c.idArea.descripcion, c.idTipomaterial.descripcion,"
                + "c.subFamiliasidsubFam.nombre, c.inventariable, c.showInQuery  FROM TblMaterial c WHERE c.subFamiliasidsubFam.idsubFam = :id");
        query.setParameter("id", id);
        List<TblMaterial> data = mtlResults(query);
        return data;
    }
    ...
    private List<TblMaterial> mtlResults(Query query) {
        ...
        for (Iterator it = list.iterator(); it.hasNext();) {
            ...
            temp.setShowInQuery((Boolean) object[14]);
            data.add(temp);
        }
        return data;
    }
    ...
    public List<TblMaterial> catalogFindBySubFam(int id, String patronName) {  //wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww
        Query res = em.createQuery("SELECT c.idtblMaterial,c.noParte,c.nombre,c.descripcion,c.stock,c.costo,c.imagen, c.idArea.idArea, c.idTipomaterial.idTipomaterial,c.subFamiliasidsubFam.idsubFam , c.idArea.descripcion, c.idTipomaterial.descripcion, c.subFamiliasidsubFam.nombre, c.inventariable, c.showInQuery  FROM TblMaterial c WHERE c.nombre LIKE  :part AND c.subFamiliasidsubFam.idsubFam = :id");
        res.setParameter("part", patronName.toLowerCase() + "%");
        res.setParameter("id", id);
        List<TblMaterial> data = mtlResults(res);
    ...
    public List<TblMaterial> catalogFindBySubFam(int id, String patronPartNumber, int x) {   //wwwwwwwwwwwwwwwwwwwwwwwwwwwww
        Query res = em.createQuery("SELECT c.idtblMaterial,c.noParte,c.nombre,c.descripcion,c.stock,c.costo,c.imagen, c.idArea.idArea, c.idTipomaterial.idTipomaterial,c.subFamiliasidsubFam.idsubFam , c.idArea.descripcion, c.idTipomaterial.descripcion, c.subFamiliasidsubFam.nombre, c.inventariable, c.showInQuery  FROM TblMaterial c WHERE c.noParte LIKE  :part AND c.subFamiliasidsubFam.idsubFam = :id");
        res.setParameter("part", patronPartNumber.toLowerCase() + "%");
        res.setParameter("id", id);
        List<TblMaterial> data = mtlResults(res);
    ...
    public List<TblMaterial> catalogFindByType(int id, String patronName) {    //wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww
        Query res = em.createQuery("SELECT c.idtblMaterial,c.noParte,c.nombre,c.descripcion,c.stock,c.costo,c.imagen, c.idArea.idArea, c.idTipomaterial.idTipomaterial,c.subFamiliasidsubFam.idsubFam , c.idArea.descripcion, c.idTipomaterial.descripcion, c.subFamiliasidsubFam.nombre, c.inventariable, c.showInQuery  FROM TblMaterial c WHERE c.nombre LIKE  :part AND c.idTipomaterial.idTipomaterial = :id");
        res.setParameter("part", patronName.toLowerCase() + "%");
        res.setParameter("id", id);
        List<TblMaterial> data = mtlResults(res);
    ...
    public List<TblMaterial> catalogFindByType(int id, String patronPartNumber, int x) {   //wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww
        Query res = em.createQuery("SELECT c.idtblMaterial,c.noParte,c.nombre,c.descripcion,c.stock,c.costo,c.imagen, c.idArea.idArea, c.idTipomaterial.idTipomaterial,c.subFamiliasidsubFam.idsubFam , c.idArea.descripcion, c.idTipomaterial.descripcion, c.subFamiliasidsubFam.nombre, c.inventariable, c.showInQuery  FROM TblMaterial c WHERE c.noParte   LIKE  :part AND c.idTipomaterial.idTipomaterial = :id");
        res.setParameter("part", patronPartNumber.toLowerCase() + "%");
        res.setParameter("id", id);
        List<TblMaterial> data = mtlResults(res);
