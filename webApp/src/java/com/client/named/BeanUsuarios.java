    ...
    public void idleListener() {
      //  FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_WARN,
       ...
       // return "faces/logIn.xhtml?faces-redirect=true";
        ...
        String url = extContext.encodeActionURL(ctx.getApplication().getViewHandler().getActionURL(ctx, "/faces/logIn.xhtml"));
...
//"faces/uicomposition/logIn.xhtml?faces-redirect=true");
    ...
    public void verificar(ComponentSystemEvent e) {
        ...
        try {
            valor = (String) fc.getSessionMap().get(usuario.getContraseña());
    ...
    public String tipo() {
        tipous = usuario.getIdTipousuarios().getIdTipousuarios();
